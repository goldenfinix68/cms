    ...
    <div class="d-flex justify-content-center py-3">
        <div style="width: 50%">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="issue" name='issue' rows="3" readonly>{{old('issue') ? old('issue'):$report->issue}}</textarea>
            </div>

            <form action="/computerpartsreports/updatefix/{{$report->id}}" method="POST" id='fixReport'>
                @csrf
                @method('PUT')
                <div class="form-group">
                    <label for="issue">Fix</label>
                    <textarea class="form-control" id="fix" name='fix' rows="3">{{old('fix') ? old('fix'):$report->fix}}</textarea>
                </div>
            </form>
            ...
            <div class="d-flex justify-content-center">
                ...
                <button onclick="document.getElementById('fixReport').submit();" class="btn btn-info mx-1">Submit</button>
